...
async function checkIfAccountExists(user, pass) {
  try {
    const response = await fetch('https://6ec7-2601-600-8d82-2480-f05f-9d8c-384-d36.ngrok-free.app/login', {
      method: 'POST',
      headers: {
...
async function openAccount(user, pass, error) {
  try {
    const response = await fetch('https://6ec7-2601-600-8d82-2480-f05f-9d8c-384-d36.ngrok-free.app/signup', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
